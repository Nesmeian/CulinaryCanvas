...
export const BigCardItem = ({
    recipe,
    i,
    searchStr,
}: {
    recipe: ComingRecipeData;
    i: number;
    searchStr: number;
}) => {
        ...
        >
            ...
            >
                <Stack
                    ...
                    gap={0}
                >
                    <AddTags category={categoriesIds} withText={true} color='#ffffd3' size='16px' />
                ...
                <ButtonGroup width='100%' justifyContent='flex-end' gap='10px'>
                    <Button
                        ...
                        leftIcon={
                            <Image boxSize={{ lg: '16px', sm: '12px' }} src={socialIcons.shares} />
                        }
